...
if __name__ == "__main__":
        ...
        s = socket.socket(socket.AF_CAN, socket.SOCK_RAW, socket.CAN_RAW) #family, type, protocol
        s.bind(('can0',))
        ...
        joyx = 0
        start_delay = 0
        joy_id = '02000100' #hardcoded assigned device number is not applicable to all network configs!
